  ...
  <main class="w-full px-4 sm:p-0 sm:w-2/3  flex flex-col items-center gap-4">
    ...
    <div class="flex justify-between w-full  items-center">
      ...
      <RouterLink class="px-2 py-1 bg-emerald-400 text-black hover:shadow-md hover:brightness-75 flex group transition-all "
        ...
        <span class="group overflow-hidden whitespace-nowrap opacity-0 max-w-0 group-hover:max-w-[10rem] group-hover:mr-1 group-hover:opacity-100 transition-all duration-500">
          Next Page
